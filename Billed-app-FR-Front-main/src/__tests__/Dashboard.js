...
import Dashboard, { filteredBills, cards, getStatus } from "../containers/Dashboard.js"
...
describe('Given I am connected as an Admin', () => {
  ...
  describe('When I am on Dashboard page and I click on arrow', () => {
    test('Then, tickets list should be unfolding, and cards should appear', async () => {
      ...
      const handleShowTickets1 = jest.fn(() => dashboard.handleShowTickets(bills, 1))
      const handleShowTickets2 = jest.fn(() => dashboard.handleShowTickets(bills, 2))
      const handleShowTickets3 = jest.fn(() => dashboard.handleShowTickets(bills, 3))
...
describe("Given I am a user connected as Admin", () => {
  ...
  test("When I'm into Dashboard, I test the getStatus function if returned 'pending'", () => {
    const status = jest.fn(() => getStatus(1))
    status()
    expect(status()).toBe("pending")
    expect(status).toHaveBeenCalled()
  })
  test("When I'm into Dashboard, I test the getStatus function if returned 'accepted'", () => {
    const status = jest.fn(() => getStatus(2))
   
    expect(status()).toBe("accepted")
    expect(status).toHaveBeenCalled()
  })
  test("When I'm into Dashboard, I test the getStatus function if returned 'refused'", () => {
     const status = jest.fn(() => getStatus(3))
     status()
